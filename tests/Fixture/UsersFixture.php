...
class UsersFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'emailaddress' => ['type' => 'string', 'length' => 255, 'null' => true, 'default' => null, 'collate' => 'latin1_swedish_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'created' => '2019-04-16 02:04:58',
                'modified' => '2019-04-16 02:04:58'
            ],
        ];
        parent::init();
    }
